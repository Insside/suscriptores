<?php
/** Campos * */
$f->campos['solicitud'] = $f->getText(array("id" => "solicitud", "type" => "text", "value" => $v['solicitud'], "class" => "required primario", "readonly" => true, "maxlenght" => 10));
...
/** Filas * */
$f->fila["fp0"] = $f->fila("<h2>XXDatos del Registro</h2>");
$f->fila["fp1"] = $f->fila($f->celdas["solicitud"] .$f->celdas["suscriptor"] . $f->celdas["creado"] . $f->celdas["actualizado"]);
