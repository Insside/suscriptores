...
if ($permiso) {
 ...
 $formulario->campos['criterio'] = $suscriptores->combo_campos("criterio", @$_REQUEST['campo']);
 ...
 echo($formulario->JavaScript("MUI.Suscriptores_Buscar_Avanzado('" . @$_REQUEST['criterio'] . "','" . @$_REQUEST['busqueda'] . "');"));
$formulario->eClick("basica", "MUI.Suscriptores_Buscador();");
} else {
 /**
