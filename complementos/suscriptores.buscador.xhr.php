...
if (!isset($_REQUEST['trasmision'])) {
  require_once($ROOT . "modulos/suscriptores/complementos/suscriptores/suscriptores.inc.php");
} else {
  require_once($ROOT . "modulos/suscriptores/complementos/suscriptores/suscriptores.inc.php");
  require_once($ROOT . "modulos/suscriptores/complementos/suscriptores/suscriptores.procesador.inc.php");
}
echo($f->generar());
echo($f->cierre());
?>